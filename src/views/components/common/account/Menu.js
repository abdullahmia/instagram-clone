  ...
  return (
    <div className="w-[236px] border-r dark:border-[#2d343b] lg:block hidden">
      ...
      <div className="px-6 mt-7 mb-6">
        <button className="text-[#0095f6] text-[14px] font-[600]">
          Switch to professional account
        </button>
      </div>

      <div className="border-t p-8 flex flex-col gap-2 dark:border-[#2d343b]">
        <div>
          <svg
        ...
        <Link to="/" className="text-[#0095f6] text-[16px] font-[700]">
          Account Center
        </Link>
